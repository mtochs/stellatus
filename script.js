...
// Email capture modal - delegate to download-modal.js
// This ensures we use the proper Resend API integration
function openEmailCapture(event) {
  if (event) event.preventDefault();
  // Use the download modal from download-modal.js
  if (typeof window.openDownloadModal === 'function') {
    window.openDownloadModal(event);
  }
}
